    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm w-screen">
      <div className="w-full px-4 py-4 max-w-full">
        ...
        <div className="flex items-center justify-between gap-8 flex-wrap md:flex-nowrap">
          ...
          {/* Menu sempre visibile, ma sotto il logo su schermi piccoli - Hidden for admin users and during session loading */}
          {mounted && !session?.user?.isAdmin && (
            <div className="order-3 md:order-2 w-full md:w-auto md:ml-auto pt-4 md:pt-0 border-t md:border-t-0 border-gray-100 md:border-gray-100">
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-2 sm:gap-3 md:gap-4 lg:gap-6">
                ...
                <Link href="/" className="text-base sm:text-lg md:text-xl text-gray-700 hover:text-[#866f59] font-medium transition-colors">
                  Home
                </Link>
                <Link href="/catalogo" className="text-base sm:text-lg md:text-xl text-gray-700 hover:text-[#866f59] font-medium transition-colors">
                  Catalogo
                </Link>
                <Link href="/contatti" className="text-base sm:text-lg md:text-xl text-gray-700 hover:text-[#866f59] font-medium transition-colors">
                  Contatti
                </Link>
