    ...
    <HydrateClient>
      ...
      <main className="flex flex-col bg-white overflow-hidden">
        ...
        <section id="esclusiva-collezione" className="relative w-full overflow-hidden pt-20 pb-24 md:pt-40 md:pb-32">
          ...
          <div className="w-full flex flex-col items-center justify-center gap-16 px-4">
            {/* Hero Header */}
            <div className="text-center animate-in fade-in slide-in-from-bottom-4 duration-1000 max-w-4xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 max-w-4xl mx-auto">
                <div className="flex flex-col items-center gap-3 p-6 bg-white border border-gray-200 hover:shadow-lg transition-all duration-300">
                  <span className="text-5xl">🚚</span>
                  <span className="font-bold text-gray-900 text-lg">Consegna a Casa</span>
                  <span className="text-sm text-gray-600 text-center">Spedizione gratuita direttamente a casa tua, con imballaggio sicuro e tracciamento</span>
                </div>
                <div className="flex flex-col items-center gap-3 p-6 bg-white border border-gray-200 hover:shadow-lg transition-all duration-300">
                  <span className="text-5xl">🛏️</span>
                  <span className="font-bold text-gray-900 text-lg">Montaggio Incluso</span>
                  <span className="text-sm text-gray-600 text-center">I nostri esperti montano il materasso e il letto a casa tua senza costi aggiuntivi</span>
                </div>
                <div className="flex flex-col items-center gap-3 p-6 bg-white border border-gray-200 hover:shadow-lg transition-all duration-300">
                  <span className="text-5xl">♻️</span>
                  <span className="font-bold text-gray-900 text-lg">Smaltimento Gratuito</span>
                  <span className="text-sm text-gray-600 text-center">Rimuoviamo e smaltiremo correttamente il tuo vecchio materasso</span>
                </div>
              </div>
            </div>
